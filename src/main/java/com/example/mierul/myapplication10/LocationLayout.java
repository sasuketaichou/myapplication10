...
public class LocationLayout extends AppCompatActivity implements ConnectionCallbacks,
    ...
    @Override
    public boolean onCreateOptionsMenu(Menu share_menu) {
        // Inflate share_menu resource file.
        getMenuInflater().inflate(R.menu.menu_location, share_menu);

        // Locate MenuItem with ShareActionProvider
        MenuItem item = share_menu.findItem(R.id.menu_item_location);
